...
export function FullscreenExpandableCards() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 top-[0] z-[100]">
            <motion.button
              ...
              className="flex absolute top-4 right-4 z-[200] items-center justify-center bg-white rounded-full h-10 w-10 shadow-md"
            ...
            >
              ...
              <div className="h-1/2 flex flex-col overflow-auto">
                <div className="flex justify-between items-start p-6">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-6 py-3 text-base rounded-full font-bold bg-green-500 text-white hover:bg-green-600 transition-colors"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
      ...
      <div className="w-full max-w-6xl mx-auto overflow-x-auto py-8 px-4">
        <div
